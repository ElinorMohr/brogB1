...
/**
 * Basically en carbon-copy af esp-idf-provisioning-android/ProvisionActivity
 * https://github.com/espressif/esp-idf-provisioning-android/blob/master/app/src/main/java/com/espressif/ui/activities/ProvisionActivity.java
 *
 * @author Theis Villumsen s195461
 */
public class ConnectStep5ProvisionActivity extends AppCompatActivity {
    private static final String TAG = ConnectStep5ProvisionActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ssidValue = intent.getStringExtra("wifi_name");
        passphraseValue = intent.getStringExtra("wifi_pass");
    ...
    private void initViews() {
        ...
        btnOk = findViewById(R.id.btn_done_prov);
